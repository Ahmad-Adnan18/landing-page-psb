...
const form = useForm({
    nama: props.testimoni.nama,
    jabatan: props.testimoni.jabatan,
    perusahaan: props.testimoni.perusahaan,
    konten: props.testimoni.konten,
    rating: props.testimoni.rating,
    is_aktif: props.testimoni.is_aktif,
    foto: null,
})

const previewUrl = ref(props.testimoni.foto_url || null)
...
const handleFileChange = (event) => {
    ...
    if (file) {
        ...
        form.foto = null
        previewUrl.value = props.testimoni.foto_url || null
    }
}
...
const submit = () => {
    ...
    form.put(route('admin.testimoni.update', props.testimoni.id), options)
}
</script>

<template>
    <Head title="Edit Testimoni - Admin" />
